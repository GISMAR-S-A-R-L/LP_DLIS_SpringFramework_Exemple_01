...
public class MainEx04Singleton {

	public static void main(String[] args) {
		ApplicationContext applicationContext = new ClassPathXmlApplicationContext("application_context_04.xml");

		System.out.println("Salutation en mode 'singleton'");
		System.out.println("Création du message01");
		Message message01 = (Message) applicationContext.getBean("salutation_singleton");
		...
		Message message02 = (Message) applicationContext.getBean("salutation_singleton");
